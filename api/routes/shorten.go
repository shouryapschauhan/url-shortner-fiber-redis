...
import (
	...
	"github.com/shouryapschauhan/shorten-url-golang-redis/helpers"
)
...
func ShortenURL(c *fiber.Ctx) error {
	...
	// A user from specific IP can only access us 10 times in 30 minutes
	...
	if !helpers.RemoveDomainError(body.URL) {
		c.Status(fiber.StatusBadRequest).JSON(fiber.Map{"error": "Ambegious URL"})
	}
	//enforce https,SSL
